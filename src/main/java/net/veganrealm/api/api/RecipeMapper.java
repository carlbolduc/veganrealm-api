...
public class RecipeMapper implements ResultSetMapper<Recipe>{
    ...
    public Recipe map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        return new Recipe(r.getInt("id"), r.getString("author"), r.getString("title"), r.getString("link"), r.getString("image_link"), r.getString("ingredients"), r.getTimestamp("published_at"));
    }
}
